 ...
 */
function leatherblacksmith_customize( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'header_logo', array(
		'label'       => __( 'Upload Header Logo', 'leatherblacksmith' ),
		'description' => __( 'Height: &gt;80px', 'leatherblacksmith' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar Scheme', 'leatherblacksmith' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'navbar-light bg-light'  => __( 'Default', 'leatherblacksmith' ),
						'navbar-dark bg-dark'    => __( 'Dark', 'leatherblacksmith' ),
						'navbar-dark bg-primary' => __( 'Primary', 'leatherblacksmith' ),
					),
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar', 'leatherblacksmith' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'static'       => __( 'Static', 'leatherblacksmith' ),
						'fixed_top'    => __( 'Fixed to top', 'leatherblacksmith' ),
						'fixed_bottom' => __( 'Fixed to bottom', 'leatherblacksmith' ),
					),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'     => 'checkbox',
		'label'    => __( 'Show Searchfield?', 'leatherblacksmith' ),
		'section'  => 'theme_header_section',
		'settings' => 'search_enabled',
		'priority' => 3,
	) );
}
add_action( 'customize_register', 'leatherblacksmith_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function leatherblacksmith_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'leatherblacksmith_customize_preview_js' );
